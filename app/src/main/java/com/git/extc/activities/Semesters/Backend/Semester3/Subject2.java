...
import com.git.extc.databinding.SemThreeActivitySubject2Binding;
...
public class Subject2 extends AppCompatActivity {
    ...
    SemThreeActivitySubject2Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemThreeActivitySubject2Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterThree/ElectronicsDeviceAndCircuits";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterThree/ElectronicsDeviceAndCircuits/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterThree/ElectronicsDeviceAndCircuits/Syllabus";
