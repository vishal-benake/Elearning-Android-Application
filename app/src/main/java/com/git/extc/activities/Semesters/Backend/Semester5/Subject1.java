...
import com.git.extc.databinding.SemSixActivitySubject1Binding;
...
public class Subject1 extends AppCompatActivity {
    ...
    SemFiveActivitySubject1Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemFiveActivitySubject1Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalCommunication";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalCommunication/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalCommunication/Syllabus";
