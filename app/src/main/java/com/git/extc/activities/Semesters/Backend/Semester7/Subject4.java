package com.git.extc.activities.Semesters.Backend.Semester7;
...
import com.git.extc.databinding.SemSevenActivitySubject4Binding;
...
SemSevenActivitySubject4Binding binding;
Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // setContentView(R.layout.sem_seven_activity_subject4);
        binding = SemSevenActivitySubject4Binding.inflate(getLayoutInflater());
        ...
        new Subject4.JSONDownloader(context).retrieve(binding.gridview, binding.myprogressBar);
        ...
        binding.refreshBtn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Subject4.JSONDownloader1(context).retrieve(binding.gridview1, binding.myprogressBar1);
            }
        });
        ...
        binding.refreshBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Subject4.JSONDownloader2(context).retrieve(binding.gridview2, binding.myprogressBar2);
            }
        });
    ...
    public class GridViewAdapter extends BaseAdapter {
        Context c;
        ArrayList<Subject4.PDFDoc> pdfDocuments;

        public GridViewAdapter(Context c,  ArrayList<Subject4.PDFDoc>pdfDocuments) {
            this.c = c;
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            ...
            final Subject4.PDFDoc pdfDoc = (Subject4.PDFDoc) this.getItem(pos);
    ...
    public class GridViewAdapter1 extends BaseAdapter {
        Context c;
        ArrayList<Subject4.YoutubeLink> youtubeVideos;

        public GridViewAdapter1(Context c,  ArrayList<Subject4.YoutubeLink>youtubeVideos) {
            this.c = c;
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            ...
            final Subject4.YoutubeLink ytlink = (Subject4.YoutubeLink) this.getItem(pos);
    ...
    public class GridViewAdapter2 extends BaseAdapter {
        Context c;
        ArrayList<Subject4.PDFDocSyllabus> pdfsyllabusDocuments;

        public GridViewAdapter2(Context c,  ArrayList<Subject4.PDFDocSyllabus>pdfsyllabusDocuments) {
            this.c = c;
        ...
        public View getView(int pos, View view, ViewGroup viewGroup) {
            ...
            final Subject4.PDFDocSyllabus pdfDoc = (Subject4.PDFDocSyllabus) this.getItem(pos);
            txtName.setText(pdfDoc.getName());
            txtAuthor.setText(pdfDoc.getAuthor());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/InternetCommunicationEngineering";
        private final Context c;

        private Subject4.GridViewAdapter adapter;
        ...
        public void retrieve(final GridView gv, final ProgressBar myProgressBar){
            final  ArrayList<Subject4.PDFDoc>pdfDocuments = new ArrayList<>();
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                ...
                                adapter = new Subject4.GridViewAdapter(c, pdfDocuments);
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/InternetCommunicationEngineering/Youtube";
        private final Context c1;

        private Subject4.GridViewAdapter1 adapter1;
        ...
        public void retrieve(final GridView gv1, final ProgressBar myProgressBar1){
            final  ArrayList<Subject4.YoutubeLink> youtubeVideos = new ArrayList<>();
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                ...
                                adapter1 = new Subject4.GridViewAdapter1(c1, youtubeVideos);
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/InternetCommunicationEngineering/Syllabus";
        private final Context c2;

        private Subject4.GridViewAdapter2 adapter;
        ...
        public void retrieve(final GridView gv, final ProgressBar myProgressBar){
            final  ArrayList<Subject4.PDFDocSyllabus>pdfsyllabusDocuments = new ArrayList<>();
                    ...
                    .getAsJSONArray(new JSONArrayRequestListener() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                ...
                                adapter = new Subject4.GridViewAdapter2(c2, pdfsyllabusDocuments);
                                gv.setAdapter(adapter);
                                myProgressBar.setVisibility(View.GONE);
                            } catch (JSONException e) {
                                myProgressBar.setVisibility(View.GONE);
