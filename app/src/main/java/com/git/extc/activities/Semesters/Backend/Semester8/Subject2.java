...
import com.git.extc.databinding.SemEightActivitySubject2Binding;
...
public class Subject2 extends AppCompatActivity {
   ...
   SemEightActivitySubject2Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = SemEightActivitySubject2Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/NetworkManagement";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/NetworkManagement/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/NetworkManagement/Syllabus";
