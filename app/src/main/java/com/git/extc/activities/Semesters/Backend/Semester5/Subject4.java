...
import com.git.extc.databinding.SemFiveActivitySubject4Binding;
...
public class Subject4 extends AppCompatActivity {
    ...
    SemFiveActivitySubject4Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemFiveActivitySubject4Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/RandomSignalAnalysis";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/RandomSignalAnalysis/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/RandomSignalAnalysis/Syllabus";
