...
import com.git.extc.databinding.SemSevenActivitySubject2Binding;
...
public class Subject2 extends AppCompatActivity {
    ...
    SemSevenActivitySubject2Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.sem_seven_activity_subject2);
        binding = SemSevenActivitySubject2Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/MobileCommunicationSystem";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/MobileCommunicationSystem/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/MobileCommunicationSystem/Syllabus";
