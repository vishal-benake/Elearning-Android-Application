package com.git.extc.activities.Semesters.Backend.Semester1;
...
import com.git.extc.databinding.SemOneActivitySubject1Binding;
import com.git.extc.databinding.SemTwoActivitySubject1Binding;
...
SemOneActivitySubject1Binding binding;
Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemOneActivitySubject1Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EngineeringMathematics1";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EngineeringMathematics1/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EngineeringMathematics1/Syllabus";
