...
import com.git.extc.databinding.SemEightActivitySubject3Binding;
...
public class Subject3 extends AppCompatActivity {
    ...
    SemEightActivitySubject3Binding binding;
    public Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = SemEightActivitySubject3Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/OpticalCommunicationNetwork";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/OpticalCommunicationNetwork/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/OpticalCommunicationNetwork/Syllabus";
