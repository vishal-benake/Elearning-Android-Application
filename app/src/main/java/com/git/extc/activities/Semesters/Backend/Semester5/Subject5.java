...
import com.git.extc.databinding.SemFiveActivitySubject5Binding;
...
public class Subject5 extends AppCompatActivity {
    ...
    SemFiveActivitySubject5Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemFiveActivitySubject5Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DataCompressionAndCryptography";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DataCompressionAndCryptography/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DataCompressionAndCryptography/Syllabus";
