...
import com.git.extc.databinding.SemSevenActivitySubject3Binding;
...
public class Subject3 extends AppCompatActivity {
    ...
    SemSevenActivitySubject3Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.sem_seven_activity_subject3);
        binding = SemSevenActivitySubject3Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/DeepLearning";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/DeepLearning/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/DeepLearning/Syllabus";
