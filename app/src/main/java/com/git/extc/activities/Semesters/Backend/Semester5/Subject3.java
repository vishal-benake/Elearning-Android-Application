...
import com.git.extc.databinding.SemFiveActivitySubject3Binding;
...
public class Subject3 extends AppCompatActivity {
    ...
    SemFiveActivitySubject3Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemFiveActivitySubject3Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalVLSI";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalVLSI/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFive/DigitalVLSI/Syllabus";
