...
import com.git.extc.databinding.ActivityAddSyllabusBinding;
...
public class AddSyllabus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddSyllabusBinding.inflate(getLayoutInflater());
                    ...
                    if (!title.equals("")  && !description.equals("")) {
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                PutData putData = new PutData("https://study-server.xyz/studyroom/AddSyllabus.php", "POST", field, data);
                                if (putData.startPut()) {
    ...
    private static class UploadPdfTask extends AsyncTask<Uri, Void, String> {
        private static final String UPLOAD_URL = "https://study-server.xyz/studyroom/upload_syllabus.php";
