...
import com.git.extc.databinding.SemSevenActivitySubject5Binding;
...
public class Subject5 extends AppCompatActivity {
    ...
    SemSevenActivitySubject5Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemSevenActivitySubject5Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/ManagementInformationSystem";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/ManagementInformationSystem/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSeven/ManagementInformationSystem/Syllabus";
