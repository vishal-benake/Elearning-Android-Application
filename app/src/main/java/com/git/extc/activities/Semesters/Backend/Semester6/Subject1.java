package com.git.extc.activities.Semesters.Backend.Semester6;
...
import com.git.extc.databinding.SemSevenActivitySubject1Binding;
...
public class Subject1 extends AppCompatActivity {
    ...
    SemSixActivitySubject1Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       
        binding = SemSixActivitySubject1Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSix/EandA";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSix/EandA/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterSix/EandA/Syllabus";
