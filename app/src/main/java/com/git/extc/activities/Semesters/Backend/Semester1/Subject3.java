...
import com.git.extc.databinding.SemOneActivitySubject3Binding;
...
public class Subject3 extends AppCompatActivity {
    ...
    SemOneActivitySubject3Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemOneActivitySubject3Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EnginneeringChemistry1";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EnginneeringChemistry1/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterOne/EnginneeringChemistry1/Syllabus";
