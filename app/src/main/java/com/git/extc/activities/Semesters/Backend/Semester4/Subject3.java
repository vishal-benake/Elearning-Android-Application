...
import com.git.extc.databinding.SemFourActivitySubject3Binding;
...
public class Subject3 extends AppCompatActivity {
    ...
    SemFourActivitySubject3Binding binding;
    Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = SemFourActivitySubject3Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFour/LinearIntegratedCircuit";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFour/LinearIntegratedCircuit/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterFour/LinearIntegratedCircuit/Syllabus";
