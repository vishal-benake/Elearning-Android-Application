package com.git.extc.activities.Semesters.Backend.Semester8;
...
import com.git.extc.databinding.SemEightActivitySubject4Binding;
...
public class Subject4 extends AppCompatActivity {
    ...
    SemEightActivitySubject4Binding binding;
    public Context context;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = SemEightActivitySubject4Binding.inflate(getLayoutInflater());
    ...
    public class JSONDownloader {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/EnvironmentManagement";
    ...
    public class JSONDownloader1 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/EnvironmentManagement/Youtube";
    ...
    public class JSONDownloader2 {
        private static final String PDF_SITE_URL = "https://study-server.xyz/studyroom/BookStore/SemesterEight/EnvironmentManagement/Syllabus";
